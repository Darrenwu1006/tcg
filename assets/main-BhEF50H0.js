var T=Object.defineProperty;var I=(u,e,s)=>e in u?T(u,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):u[e]=s;var c=(u,e,s)=>I(u,typeof e!="symbol"?e+"":e,s);import{_ as i,S as w,G as O,C as V}from"./CardDetailPanel-CMnuVq_a.js";const f=class f{constructor(){c(this,"cards",new Map);c(this,"loaded",!1)}static getInstance(){return f.instance||(f.instance=new f),f.instance}async loadAll(){if(!this.loaded)try{await this.loadConsolidatedPools(),this.loaded=!0,console.log(`CardDatabase loaded ${this.cards.size} cards.`)}catch(e){console.error("Failed to load card pools:",e)}}resolvePath(e){const s="/tcg/",t=e.startsWith("/")?e.slice(1):e;return`${s.endsWith("/")?s:`${s}/`}${t}`}async loadConsolidatedPools(){const e=this.resolvePath("pool/All_Characters.csv"),s=this.resolvePath("pool/All_Events.csv");try{const[t,n]=await Promise.all([fetch(e),fetch(s)]);if(t.ok){const a=await t.text();this.parsePoolCSV(a,"CHARACTER")}if(n.ok){const a=await n.text();this.parsePoolCSV(a,"EVENT")}console.log("Loaded consolidated pools")}catch(t){console.error("Failed to load consolidated pools:",t)}}parsePoolCSV(e,s){var n,a,o,r,d,h,m,g,v,D,L,P;const t=e.split(`
`);for(let E=1;E<t.length;E++){const C=t[E].trim();if(!C)continue;const l=this.parseCSVLine(C);if(l.length<4)continue;const M=(n=l[0])==null?void 0:n.trim(),b=(a=l[2])==null?void 0:a.trim(),S=(o=l[3])==null?void 0:o.trim();if(!b||!S)continue;const p=y=>{if(!y||y.trim()==="-"||y.trim()==="")return null;const R=parseInt(y.trim());return isNaN(R)?null:R};s==="CHARACTER"?this.cards.set(b,{id:b,name:S,type:"CHARACTER",school:M,timing:((r=l[4])==null?void 0:r.trim())||"-",rarity:((d=l[5])==null?void 0:d.trim())||"-",role:((h=l[6])==null?void 0:h.trim())||"-",stats:{serve:p(l[7]),block:p(l[8]),receive:p(l[9]),toss:p(l[10]),attack:p(l[11])},skill:((m=l[12])==null?void 0:m.trim())||"-",note:((g=l[13])==null?void 0:g.trim())||"-"}):this.cards.set(b,{id:b,name:S,type:"EVENT",school:M,rarity:((v=l[4])==null?void 0:v.trim())||"-",timing:((D=l[5])==null?void 0:D.trim())||"-",role:"-",stats:{serve:p(l[6]),block:p(l[7]),receive:p(l[8]),toss:p(l[9]),attack:p(l[10])},skill:((L=l[11])==null?void 0:L.trim())||"-",note:((P=l[12])==null?void 0:P.trim())||"-"})}}parseCSVLine(e){const s=[];let t="",n=!1;for(let a=0;a<e.length;a++){const o=e[a];o==='"'?n=!n:o===","&&!n?(s.push(t),t=""):t+=o}return s.push(t),s}getCard(e){return this.cards.get(e)}getAllCards(){return Array.from(this.cards.values())}getTotalCardCount(e){var n;const s=e.split(`
`);let t=0;for(let a=1;a<s.length;a++){const o=s[a].trim();if(!o)continue;const r=o.split(",");if(r.length<2)continue;let d=0;if(r.length>=3){const h=(n=r[2])==null?void 0:n.trim();if(h){const m=parseInt(h);isNaN(m)||(d=m)}}t+=d}return t}async getAvailableDecks(){const e=Object.assign({"/src/assets/decks/伊達工業/攔網軸.csv":()=>i(()=>import("./攔網軸-D3jIr5hL.js"),[]).then(t=>t.default),"/src/assets/decks/梟谷/template.csv":()=>i(()=>import("./template-YZRRei5E.js"),[]).then(t=>t.default),"/src/assets/decks/梟谷/爆發軸二.csv":()=>i(()=>import("./爆發軸二-DRygAH0m.js"),[]).then(t=>t.default),"/src/assets/decks/梟谷/高爆發軸.csv":()=>i(()=>import("./高爆發軸-OlfSSk9F.js"),[]).then(t=>t.default),"/src/assets/decks/混合學校/template.csv":()=>i(()=>import("./template-BL6p7JrW.js"),[]).then(t=>t.default),"/src/assets/decks/混合學校/垃圾場.csv":()=>i(()=>import("./垃圾場-DLQNSA_3.js"),[]).then(t=>t.default),"/src/assets/decks/烏野/template.csv":()=>i(()=>import("./template-Dl-KCfeZ.js"),[]).then(t=>t.default),"/src/assets/decks/烏野/山月攔網軸.csv":()=>i(()=>import("./山月攔網軸-C9q-UzZd.js"),[]).then(t=>t.default),"/src/assets/decks/烏野/日影攻擊軸.csv":()=>i(()=>import("./日影攻擊軸-B5nYVoJQ.js"),[]).then(t=>t.default),"/src/assets/decks/烏野/預組.csv":()=>i(()=>import("./預組-CkakcnPP.js"),[]).then(t=>t.default),"/src/assets/decks/白鳥沢/白板軸.csv":()=>i(()=>import("./白板軸-p2O_xymA.js"),[]).then(t=>t.default),"/src/assets/decks/白鳥沢/白鳥沢 - All Cards.csv":()=>i(()=>import("./白鳥沢 - All Cards-fWYDIa0f.js"),[]).then(t=>t.default),"/src/assets/decks/稲荷崎/六名軸.csv":()=>i(()=>import("./六名軸-y2KcxgZM.js"),[]).then(t=>t.default),"/src/assets/decks/稲荷崎/稲荷崎 - All Cards.csv":()=>i(()=>import("./稲荷崎 - All Cards-DeyQNAiw.js"),[]).then(t=>t.default),"/src/assets/decks/青葉城西/template.csv":()=>i(()=>import("./template-BgW2zTP9.js"),[]).then(t=>t.default),"/src/assets/decks/青葉城西/中速軸.csv":()=>i(()=>import("./中速軸-Csfw3ekW.js"),[]).then(t=>t.default),"/src/assets/decks/青葉城西/快攻軸.csv":()=>i(()=>import("./快攻軸-BS8Dq3Be.js"),[]).then(t=>t.default),"/src/assets/decks/音駒/template.csv":()=>i(()=>import("./template-CxhDpovY.js"),[]).then(t=>t.default),"/src/assets/decks/音駒/預組.csv":()=>i(()=>import("./預組-1IW_7lEd.js"),[]).then(t=>t.default)}),s=[];for(const t in e){const n=t.split("/"),a=n[n.length-1],o=n[n.length-2],r=a.replace(".csv","");try{const d=await e[t](),h=this.getTotalCardCount(d);h===40&&s.push({school:o,name:r,path:t,loader:e[t],cardCount:h})}catch(d){console.warn(`Failed to load deck at ${t}:`,d)}}return s}async loadDeck(e){try{const s=await e();return this.parseDeckCSV(s)}catch(s){return console.error("Failed to load deck:",s),[]}}parseDeckCSV(e){var n,a;const s=e.split(`
`),t=[];for(let o=1;o<s.length;o++){const r=s[o].trim();if(!r)continue;const d=r.split(",");if(d.length<2)continue;const h=(n=d[1])==null?void 0:n.trim();let m=0;if(d.length>=3){const v=(a=d[2])==null?void 0:a.trim();if(v){const D=parseInt(v);isNaN(D)||(m=D)}}if(!h||m===0)continue;const g=this.getCard(h);if(g)for(let v=0;v<m;v++)t.push({...g,instanceId:crypto.randomUUID()});else console.warn(`Card ID not found in pool: ${h}`)}return t}};c(f,"instance");let _=f;class ${constructor(e){c(this,"element");c(this,"store");c(this,"meDeckLoaded",!1);c(this,"opDeckLoaded",!1);c(this,"firstPlayerDecided",!1);c(this,"availableDecks",[]);this.store=e,this.element=document.createElement("div"),this.element.className="setup-overlay",this.loadDatabase(),this.render()}async loadDatabase(){const e=_.getInstance();await e.loadAll(),console.log("CardDatabase ready"),this.availableDecks=await e.getAvailableDecks(),this.render(),this.loadDefaultDecks()}render(){const e=this.availableDecks.map(s=>`<option value="${s.path}">${s.school} - ${s.name}</option>`).join("");this.element.innerHTML=`
